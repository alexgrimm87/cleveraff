...
$(document).ready(function(){
   ...
   validate('.reg-form-popup', {submitFunction:validationCall});
   validate('.login-form-popup', {submitFunction:validationCall});
   validate('.form', {submitFunction:validationCall});
